...
public final class ScannerDbSql {
  ...
  public static final class Records {
    ...
    public static final String CREATE = "CREATE TABLE " + RecordEntry.TABLE_NAME + " ("
        + RecordEntry.COLUMN_NAME_IDENTIFIER + TEXT_TYPE + PK + NN + COMMA_SEP 
        ...
        + RecordEntry.COLUMN_NAME_WHEN_UNLOCKED + TEXT_TYPE + COMMA_SEP
        + RecordEntry.COLUMN_NAME_MESSAGE + TEXT_TYPE + NN + COMMA_SEP
        + RecordEntry.COLUMN_NAME_SUMMARY + TEXT_TYPE + NN 
        + " )";
  ...
  public static final class Research {
    public static final String CREATE = "CREATE TABLE " + ResearchEntry.TABLE_NAME + " ("
        + ResearchEntry.COLUMN_NAME_VISIBLE + INTEGER_TYPE + NN + COMMA_SEP + ResearchEntry.COLUMN_NAME_TRACK
        + TEXT_TYPE + NN + COMMA_SEP + ResearchEntry.COLUMN_NAME_SUMMARY + TEXT_TYPE + NN + COMMA_SEP
        + ResearchEntry.COLUMN_NAME_RULES + TEXT_TYPE + NN + COMMA_SEP + ResearchEntry.COLUMN_NAME_LOCKED
        + INTEGER_TYPE + NN + COMMA_SEP + ResearchEntry.COLUMN_NAME_FLUFF + TEXT_TYPE + NN + COMMA_SEP
  ...
  public static final class Location {
    public static final String CREATE = "CREATE TABLE " + GpsLocation.TABLE_NAME + " ("
        + GpsLocation.COLUMN_NAME_SUMMARY + TEXT_TYPE + NN + COMMA_SEP +
        GpsLocation.COLUMN_NAME_START + TEXT_TYPE + COMMA_SEP +
        GpsLocation.COLUMN_NAME_END + TEXT_TYPE + COMMA_SEP +
        GpsLocation.COLUMN_NAME_OPTIMUM + TEXT_TYPE + COMMA_SEP +
        GpsLocation.COLUMN_NAME_TIMED + INTEGER_TYPE + COMMA_SEP +
        ...
        GpsLocation.COLUMN_NAME_NEEDED + INTEGER_TYPE + NN + COMMA_SEP +
        GpsLocation.COLUMN_NAME_SNIFFED + INTEGER_TYPE + NN + COMMA_SEP +
        GpsLocation.COLUMN_NAME_RECORD + TEXT_TYPE + NN + COMMA_SEP +
        GpsLocation.COLUMN_NAME_ID + INTEGER_TYPE + PK + NN + " )";

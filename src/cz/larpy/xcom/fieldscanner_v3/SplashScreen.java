...
public class SplashScreen extends Activity {
  private static int SPLASH_MESSAGE_SWITCH = 600;
  private static int SPLASH_MESSAGE_DOT = 200;
  private static int messages[] = { R.string.splash_message_1_kernel_initialization,
      R.string.splash_message_2_key_verification, R.string.splash_message_3_sensor_calibration,
      R.string.splash_message_4_nsa_notification, R.string.splash_message_5_facebook_scan };
  private int counter = 0;
  private Handler handler;

  private final Runnable toggleMessageHandler = new Runnable() {
    @Override
    public void run() {
      toggleMessage();
    }
  ...
  private final Runnable dotter = new Runnable() {
